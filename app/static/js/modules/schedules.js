...
const {
  ...
  scheduleIntervalMinutesInput,
  scheduleIntervalWrap,
  scheduleIntervalCustomWrap,
  scheduleRunModeInput,
  scheduleCooldownInput,
  scheduleCooldownWrap,
  schedulerStatusEl,
  scheduleMinScoreInput,
  scheduleAutoImportInput,
} = dom;
