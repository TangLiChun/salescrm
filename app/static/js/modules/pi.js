...
const { piChatMessagesEl, piChatForm, piChatInput, piChatSendBtn, piChatStopBtn, piChatClearBtn, piChatHistoryHintEl, piChatContextMeterEl, piChatContextMeterFillEl, piChatContextMeterLabelEl, piChatBackgroundInput, piThreadListEl, piChatProgressEl, piChatProgressFill, piChatProgressText, leadQueryInput, minScoreInput, autoImportInput, piChatShellEl, piLlmSetupEl, piGotoLlmSettingsBtn, piInputHintEl, piMobileTabChatBtn, piMobileTabThreadsBtn, } = dom;
...
export async function importPiChatLookup(toolEl) {
    const selectedRows = Array.from(toolEl?.querySelectorAll("tr.selected") || []);
